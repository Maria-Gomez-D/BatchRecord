  ...
  return (
    <div className="flex flex-col bg-white min-h-screen">
      ...
      <div className="flex-1 p-8">
        <form onSubmit={handleSubmit} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 max-w-7xl mx-auto">
          ...
          <div className="mb-4">
            ...
            <div className="border rounded h-[calc(100vh-24rem)] overflow-y-auto">
              {/* Add header row */}
              <div className="grid grid-cols-12 gap-2 p-3 bg-gray-100 font-bold border-b">
              ...
              {filteredUsers.length > 0 ? (
                filteredUsers.map(user => (
                  <div 
                    key={user.email} 
                    className={`grid grid-cols-12 gap-2 p-3 cursor-pointer hover:bg-gray-100 border-b ${
                      selectedUser && selectedUser.email === user.email ? 'bg-blue-100' : ''
                    }`}
                  ...
                  >
                    ...
                    <div className="col-span-3">
                      <span className={`px-3 py-1.5 rounded text-sm font-bold ${getRoleColor(user.role)}`}>
                        {user.role}
                      </span>
                    </div>
                  </div>
                ...
                <div className="p-3 text-gray-500">No users match the current filters</div>
              )}
            </div>
          </div>
